...
import logo from "images/cofoods-logo.png";
...
export default ({
  ...
  heading = "Trusted Software Consultants, Ready to Join Your Team.",
  description = "17 years of industry experience of design and development of softwares in Banking and Finance domain. Experties in Application modernization, digital transformation and Cloud native Application design"
}) => {
  /*
        ...
        <Content2Xl>
          <NavRow>
            ...
            <div tw="flex flex-wrap justify-center lg:justify-end items-center -mr-12">
             ...
             {/*   License & Usage*/}
             {/* </NavLink>*/}
              <NavLink target="_blank" href="https://www.prashanttalele.com">
                Who Am I ?
              </NavLink>
              <NavLink target="_blank" href="https://twitter.com/ptalele">
                Twitter
              </NavLink>
              <NavLink target="_blank" href="mailto:Prashant@cofoodsprocessor.com">
                Hire Me!
              </NavLink>
          ...
          <SectionContainer id="componentDemos">
            ...
            {/*   Reach us @info@cofoodsprocessor.com*/}
            {/*  </span>*/}
            {/*</SectionDescription>*/}
            <FiveColumnDarkFooter></FiveColumnDarkFooter>
